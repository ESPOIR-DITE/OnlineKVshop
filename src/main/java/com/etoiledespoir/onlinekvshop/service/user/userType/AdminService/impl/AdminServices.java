package com.etoiledespoir.onlinekvshop.service.user.userType.AdminService.impl;
...
import com.etoiledespoir.onlinekvshop.repository.user.userType.AdminRepo.AdminInt;
import com.etoiledespoir.onlinekvshop.service.user.userType.AdminService.IAdminService;
...
public class AdminServices implements IAdminService {
    ...
    public Admin Update(Admin admin) {
        Optional <Admin> myadmin=adminInt.findById(admin.getEmail());
        if(myadmin!=null){
           adminInt.save(admin);
        }
        return myadmin.orElse(null);
